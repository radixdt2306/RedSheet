...
{
    public class ProjectNegotiationLookupContext : DbContext, IProjectNegotiationLookupContext
    {
        public ProjectNegotiationLookupContext(MainSqlDbContext mainSqlDbContext)
        {
    ...
    public interface IProjectNegotiationLookupContext : IDbContext
    {
    }
}
