...
import { PopoverModule } from 'app/components/login/Popover/popover.module';


@NgModule({
    imports: [
        RESET_PASSWORD_ROUTING,
        CommonModule, RxViewModule, RxTableModule, FormsModule, ReactiveFormsModule, RxFormsModule,PopoverModule
    ],    
