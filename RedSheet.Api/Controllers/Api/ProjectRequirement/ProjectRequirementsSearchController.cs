...
{
    [Route("api/projectrequirements/search")]
    public class ProjectRequirementsSearchController : BaseController
    {
        private IDbContextManager<MainSqlDbContext> DbContextManager { get; set; }
        public ProjectRequirementsSearchController(IDbContextManager<MainSqlDbContext> dbContextManager)
        {
        ...
        public  async Task<IActionResult> Post(StoreProcSearchModel storeProcSearch) {
            ...
            var storeProcSearchResult = await DbContextManager.SqlQueryAsync<StoreProcSearchViewModel>("EXEC dbo.spProjectRequirements @Query, @UserId", spParameters);
