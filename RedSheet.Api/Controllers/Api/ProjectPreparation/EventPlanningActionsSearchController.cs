...
{
    //[Route("api/eventplanningactions/search")]
    [Route("api/projectpreparations/{projectPreparationId}/eventplanningactions/search")]
    public class EventPlanningActionsSearchController : BaseController
    {
        private IDbContextManager<MainSqlDbContext> DbContextManager { get; set; }
        public EventPlanningActionsSearchController(IDbContextManager<MainSqlDbContext> dbContextManager)
        {
